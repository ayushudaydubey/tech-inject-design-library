  ...
  return (
    <div className={`relative flex-1 ${className}`}>
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-2.5 rounded-xl border border-zinc-800 bg-zinc-900 text-xs sm:text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-blue-200 focus:border-zinc-700 transition-colors"
      />
      {value && (
        <button
          type="button"
